...
def prepare_image(url):
    ...
    image_resized = image.resize((224, 224))  # для подачи в модель

    # Преобразуем в numpy и нормализуем как требует MobileNetV2
    ...
    return image_tensor, image  # возвращаем оригинал для отображения
